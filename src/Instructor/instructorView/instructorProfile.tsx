            ...
            <div className="mx-6 my-6">
                <div className="flex items-center gap-4 ">
                    ...
                    <div className="">
                     ...
                     <p className="text-sm sm:text-md text-gray-500">{role}</p> 
                    </div>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <input type="text" className="bg-gray-100 border text-sm border-gray-300 placeholder-black rounded-lg px-4 py-2 h-9 font-medium sm:h-10" placeholder={role || ""} disabled />
