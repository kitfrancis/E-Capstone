    ...
    <div className="scroll-smooth font-Poppins">
        <div className="lg:ml-64 mt-15 sm:mt-20 mx-3 px-3 max-h-auto lg:px-5 ">
            ...
            <div className="bg-gray-200 rounded-full p-1 flex w-full max-w-auto mt-5 md:mt-10">
              ...
              <button onClick={() => navigate("/instructorTask")} className="flex-1 text-sm text-gray-600 font-medium py-2 rounded-full hover:bg-gray-100">
                Tasks
              </button>
             ...
             <div className="bg-gray-100 mt-4 md:mt-6 rounded-lg p-4 px-7  mb-6">
               <div className="flex flex-col mt-4 md:mt-2 ">
                <div className="flex justify-between">
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-500">Team Name - Phase:Proposal</p>
                  </div>
               ...
               <div className="flex justify-between items-center mt-4 md:mt-6 pb-3">
                ...
                <h1 className="text-gray-500 text-sm md:text-md">Version</h1>
                <h1 className="text-gray-500 text-sm md:text-md">2 Comments</h1>
              </div>
            </div>
             {openCreateTeam && (
