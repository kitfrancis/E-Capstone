...
export default function Archive() {
  ...
  },
  {
  ...
  },
   {
    ...
    archivedDate: "2026-05-10",
    keywords: ["Campus", "Web-Base", "Mobile ", "responsive","Campus", "Navigation", "Mobile"],
    members: [
    ...
    abstract: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum ex soluta recusandae dolor, dolores exercitationem sequi voluptas quasi dolorem, minus fuga assumenda blanditiis nost.",
    archivedDate: "2026-05-10",
    keywords: ["Web-Base", "Real-time", "Campus", "Responsive"],
    members: [
              "Kit Francis S. Besa",
              "Carl Andrei Diomon",
              "Stephen Gabarda",
  ...
  return (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 mt-5 py-3">
                      ...
                      <div className="space-y-1 flex flex-col">
                        ...
                        <select name="Department" id="department" className="bg-white border text-sm border-gray-300 rounded-lg px-4 py-2 h-9 sm:h-10 font-semibold">
                            <option value="allDepartment">All Department</option>
                            <option value="current">Information Technology</option>
                        </select>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-5 md:mt-8 items-start "> 
              <div className="space-y-4 ">
                 ...
                 {projects.map((project, index) => (
                  <div key={index} onClick={() => setSelectedProject(project)} className=" bg-gray-100 mt-4 md:mt-6 rounded-lg p-4 px-6  mb-6 hover:shadow-md">
    ...
    selectedProject ? "" : "bg-gray-100 max-h-auto md:max-h-50 justify-center"
  }`}>
                 {selectedProject ? (
                  <>
